...
define(['module', 'dustjs'], function (module, Dust) {
    'use strict';
    ...
    text = {
         ...
         * @returns {Object} with properties "moduleName" and "ext"
         */
        ...
        finishLoad: function (name, content, onLoad) {
            var
                result,
                source = Dust.compile(content, name);

            if (masterConfig.isBuild) {
                result = source + "; return function (data, callback) { Dust.render('" + name + "', data, callback); };";
                buildMap[name] = result;
                return onLoad(result);
            } else {
                Dust.loadSource(source);
                return onLoad(function (data, callback) {
